...
public class PromotionController 
{
	...
	@Autowired private IPromotionMetier promotionMetier;
	...
	public String goToFrmPromotion(Model model, HttpServletRequest request,
								   ...
								   @RequestParam(defaultValue = "0") Long idEmploi,
								   @RequestParam(defaultValue = "0") Long idGrade,
								   @RequestParam(defaultValue = "") String numActePromotion,
	...
	@PreAuthorize("hasRole('SAF')")
	public String goToFrmConfirmationPromotion(Model model, HttpServletRequest request, @ModelAttribute Promotion promotion)
	{
		...
		catch (PromotionException e)
		{
			...
			return goToFrmPromotion(model, request, 
									promotion.getAgentPromu().getIdAgent(),
									promotion.getNewFonction().getIdFonction(),
									promotion.getNewEmploi().getIdEmploi(),
									promotion.getNewGrade().getIdGrade(),
									promotion.getNumActePromotion(),
